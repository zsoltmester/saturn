...
- Using cache to decrease mobile data usage
- Support refresh on the feed screen (swipe to refresh + button)
- Support loading more news on the news screen
- Create a concept about app feedbacks and analytics (log the current print statements too)
- Adaptive layout: support iPad devices and iPhones' landscape mode
	- (reference) https://useyourloaf.com/blog/safe-area-layout-guide
	- (reference) https://www.raywenderlich.com/162311/adaptive-layout-tutorial-ios-11-getting-started
	- (reference) https://convertkit.s3.amazonaws.com/assets/documents/747/538975/iOS_Size_Classes_Quick_Guide_v1.3.pdf
- Improve feed editor screen with search, preview and source selection
- Add a launch screen
- Implement support for misc info items (likes, shares, retweets, comments...)
- App should navigate further if we click on a textview
- Fix some misplacements on the news screen, when tehere are some images missing
- Implement more modern placeholders
	- (reference) https://github.com/HamzaGhazouani/HGPlaceholders
- Integrate Instagram
- Improve Facebook support
	- Implement adding friends (or indicate, if it's not possible)
	- Integrate pictures and videos. I can try this: https://github.com/bakkenbaeck/Viewer
- Improve Twitter support
	- Change the links to pictures, videos and retweets
- Improve Reddit support
	- Support more, other then a subreddit's hot
...
- Hirdetés bannereken (Google, Apple, stb).
- Hirdetés emailben.
