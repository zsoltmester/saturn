...
3. A hírfolyamlétrehozó flow:
	...
	- második képernyője következő elemeket tartalmazza, középre igazítva:
		1. Egy text field, amivel a hírfolyam nevét lehet megadni. Ez kapja meg a fókuszt a képernyő megnyitásakor (tehát a keyboard is feljön). A fókuszt az enter megnyomásával lehet megszüntetni. Csak 1 sort lehet beírni és legfeljebb 15 karaktert. Fókusz elvesztésekor frissíti a képernyő címét a field tartalmára, ha az valid. Különben pedig a default címet teszi ki a képernyőre.
